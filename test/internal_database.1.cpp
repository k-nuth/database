...
#define DIRECTORY "/home/fernando/reorg"
...
void check_index_and_pool(MDB_env *env, MDB_dbi& dbi_index, MDB_dbi& dbi_pool) {
    ...
    while ((rc = mdb_cursor_get(cursor, &key, &data, MDB_NEXT)) == 0) {
        auto height = *static_cast<uint32_t*>(key.mv_data);
        auto res = mdb_get(txn, dbi_pool, &data, &value);
        auto b = res == MDB_SUCCESS;
    }
...
BOOST_AUTO_TEST_CASE(internal_database__reorg_index) {
    ...
    auto pool_size= db_count_items(env_, dbi_reorg_pool_);
    auto pool_index_size = db_count_items(env_, dbi_reorg_index_);

    auto i1265887 = db_count_index_by_height(env_, dbi_reorg_index_, 1265887);
    auto i1265888 = db_count_index_by_height(env_, dbi_reorg_index_, 1265888);
    auto i1265889 = db_count_index_by_height(env_, dbi_reorg_index_, 1265889);
    auto i1265890 = db_count_index_by_height(env_, dbi_reorg_index_, 1265890);
...
// BOOST_AUTO_TEST_CASE(internal_database__spend) {
//     //79880
//     auto const orig = get_block("");
//     //80000
//     auto const spender = get_block("");
...
// BOOST_AUTO_TEST_CASE(internal_database__reorg) {
...
//         BOOST_REQUIRE(db.pop_block(out_block) == result_code::success);
...
// BOOST_AUTO_TEST_CASE(internal_database__prune_2) {
