...
private:
    ...
    result_code push_transaction_points(chain::transaction tx, uint32_t height, uint32_t tx_pos,  MDB_txn* db_txn);
...
#include <bitprim/database/databases/index_service.ipp>
