...
//pivate
template <typename Clock>
result_code internal_database_basis<Clock>::insert_spend(domain::chain::output_point const& out_point, domain::chain::input_point const& in_point) {
...
template <typename Clock>
result_code internal_database_basis<Clock>::remove_transaction_spend_db(domain::chain::transaction const& tx) {
...
template <typename Clock>
result_code internal_database_basis<Clock>::remove_spend(domain::chain::output_point const& out_point) {
