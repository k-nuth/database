...
template <typename Clock>
result_code internal_database_basis<Clock>::insert_utxo(domain::chain::output_point const& point, utxo_entry const& entry, KTH_DB_txn* db_txn) {
    auto keyarr = point.to_data(KTH_INTERNAL_DB_WIRE);       //TODO(fernando): podría estar afuera de la DBTx
    auto valuearr = entry.to_data();                        //TODO(fernando): podría estar afuera de la DBTx
