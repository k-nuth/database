 ...
 */
#ifndef LIBBITCOIN_DATABASE_RECORD_ROW_SET_IPP
#define LIBBITCOIN_DATABASE_RECORD_ROW_SET_IPP
...
template <typename KeyType>
record_row_set<KeyType>::record_row_set(record_manager& manager,
...
template <typename KeyType>
array_index record_row_set<KeyType>::create(const KeyType& key,
...
template <typename KeyType>
bool record_row_set<KeyType>::compare(const KeyType& key) const
{
...
template <typename KeyType>
array_index record_row_set<KeyType>::next_index() const
{
...
template <typename KeyType>
void record_row_set<KeyType>::write_next_index(array_index next)
{
    const auto memory = raw_next_data();
...
template <typename KeyType>
const memory_ptr record_row_set<KeyType>::raw_data(file_offset offset) const
{
...
template <typename KeyType>
const memory_ptr record_row_set<KeyType>::raw_next_data() const
{
...
#endif /*LIBBITCOIN_DATABASE_RECORD_ROW_SET_IPP*/
